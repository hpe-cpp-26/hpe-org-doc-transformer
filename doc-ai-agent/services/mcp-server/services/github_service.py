...
class GitHubService:
    ...
    async def get_group_readme_content(self, group_name: str) -> str:
        """Fetch the README.md for a group under the configured org/repo base path.
        Args:
            group_name: Subfolder name under github_base_path (e.g., "self-healing-system").
        Returns:
            Decoded README.md content as plain text.
        """
        if not group_name:
